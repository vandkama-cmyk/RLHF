"""
ClassifMLP - Training Script for CONSISTENT Metric

Trains MLP classifier using the 'consistent' metric from human feedback.
"""
...
from stage4.stage4A_consist.integrated_system_consistent import train_integrated_system
import argparse


def main():
    parser = argparse.ArgumentParser(description="ClassifMLP - Training (CONSISTENT METRIC)")
    ...
    print("=" * 60)
    print("This model is trained using the 'consistent' metric from human feedback")
    print("=" * 60)
    ...
    print("Model trained on CONSISTENT metric from human feedback.")
    print("Results saved to: clasifNN/consist_mlp/artifacts/")
    print("=" * 60)
