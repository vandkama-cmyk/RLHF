"""
ClassifMLP - Training Script for USEFUL Metric

Trains MLP classifier using the 'useful' metric from human feedback.
"""
...
from stage4.stage4C_useful.integrated_system_useful import train_integrated_system
import argparse


def main():
    parser = argparse.ArgumentParser(description="ClassifMLP - Training (USEFUL METRIC)")
    ...
    print("=" * 60)
    print("This model is trained using the 'useful' metric from human feedback")
    print("=" * 60)
    ...
    print("Model trained on USEFUL metric from human feedback.")
    print("Results saved to: clasifNN/useful_mlp/artifacts/")
    print("=" * 60)
